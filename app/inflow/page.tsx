...
import { InflowNotData } from "app/inflow/InflowNotData";
import { UrlForm } from "app/inflow/UrlForm";
                  ...
                  >
                    ...
                    <div className="col-span-2 row-start-2 flex items-center gap-2">
                      <div className="hidden-scrollbar overflow-auto border text-sm font-semibold">
                        https://liff.line.me/{ownerInfo?.liffId}/inflow/{id}
                      </div>

                      <Copy
                        value={`https://liff.line.me/${ownerInfo?.liffId}/inflow/${id}`}
                      />

                      <QRCode
                        url={`https://liff.line.me/${ownerInfo?.liffId}/inflow/${id}`}
                      />
                    </div>
