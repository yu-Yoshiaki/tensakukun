  ...
  return (
    <div className="flex items-center justify-between whitespace-nowrap px-5 py-2">
      <div className="grid grid-cols-3 grid-rows-2 gap-2">
        <div className="col-span-2 h-8 w-[140px] animate-pulse bg-gray-300 text-[12px] md:text-[1px]"></div>
        <div className="col-span-2 row-start-2 flex h-5 w-[140px] animate-pulse items-center gap-2 bg-gray-300 text-lg font-bold"></div>
      </div>
      <div className="row-span-2 flex flex-col justify-center gap-1">
        <div className="h-8 w-20 animate-pulse text-xs"></div>
        <div className="h-8 w-20 animate-pulse text-xs">
